...
namespace ATS.WebUi.Helpers
{
    public static class CultureHelper
    {
        ...
        private static readonly List<string> _cultures = BLCommon.CacheHelper.GetAllLanguageList().Select(v => v.LanguageCulture).ToList();
        //    new List<string> {
        ...
        {
            return ATS.WebUi.Common.Constants.Default_Language_Culture; // return Default culture
        }
