...
{
    public class UserPrivilegesController : ATS.WebUi.Controllers.AreaBaseController
    {
        //
        // GET: /Employee/UserPrivileges/
        ...
        public ActionResult Index(string KeyMsg, Guid? userId = null)
        {
            ...
            try
            {
                ...
                if (userId == null || userId.Equals(Guid.Empty))
                {
                    ...
                    //objmodel.AvailableDivisionList = objDivisionAction.GetAllDivisionByClientAndLanguage(_CurrentLanguageId);
                    //objmodel.SelectedDivisionList = new List<BEClient.Division>();
                ...
                _bsModel.ToolTip = "USer Privileges";
        ...
        private void NavIndex(Guid? userId)
        {
            ...
            objBreadCrumb.Controller = "UserPrivileges";
            objBreadCrumb.AreaName = ATS.WebUi.Common.Constants.AREA_EMPLOYEE;
            objBreadCrumb.ordinal = 1;
            objBreadCrumb.URL = Url.Action("Index", "UserPrivileges", new { area = ATS.WebUi.Common.Constants.AREA_EMPLOYEE, @userId = userId });
            objBreadCrumb.ImagePath = BECommon.ImagePaths.CompanySetupImage;
            objBreadCrumb.ToolTip = "User Privileges"; 
            objBreadCrumb.WithoutOrdinalURL = Url.Action("Index", "UserPrivileges", new { area = ATS.WebUi.Common.Constants.AREA_EMPLOYEE });
