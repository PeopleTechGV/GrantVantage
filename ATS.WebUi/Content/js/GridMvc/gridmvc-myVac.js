...
function VacancyFilterWidget() {
    ...
    */
    ...
    this.renderWidget = function () {
        var str = this.value.filterValue;
        var html = '<div style="width:200px; max-height:120px; overflow-y:scroll;"><input id="selectAll" type="checkbox" class="grid-filter-input form-control" value="Select All">Select All</option><br>'
