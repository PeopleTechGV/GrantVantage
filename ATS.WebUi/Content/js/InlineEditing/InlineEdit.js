...
@method value2html(value, element)
        **/
        value2html: function(value, element) {
            ...
            var html = '<div class="vacancy-quest-txt"><label class="v-quest-label">' + value.LocalName + '</label></div><div class="vacancy-quest-typ"><label class="v-quest-label">' + value.QueDataType + '</label></div><div class="vacancy-quest-weight"><label style="text-align:center;" class="v-quest-label">' + value.Weight + '</label></div>'
            //var html = $('<div>').text(value.LocalName).html() + ', ' + $('<div>').text(value.QueDataType).html() +  $('<div>').text(value.Weight).html();
            $(element).html(html);
        },
        ...
        value2input: function (value) {
            ...
            this.$input.filter('[name="LocalName"]').val(value.LocalName);
            this.$select.filter('[name="QueDataType"]').val(value.QueDataType);
        ...
        input2value: function () {
            ...
            return {
                LocalName: this.$input.filter('[name="LocalName"]').val(),
                QueDataType: this.$select.filter('[name="QueDataType"]').val(),
            ...
            **/
        activate: function() {
            this.$input.filter('[name="LocalName"]').focus();
        },
    ...
    Address.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        tpl: '<div class="editable-address"><div class="vacancy-quest-txt"><input type="text" class="v-quest-txt" name="LocalName"></div>' +
    '<div class="vacancy-quest-typ"><select name="QueDataType" class="v-quest-type"><option>Small Text</option><option>Large Text</option><option>Yes/No</option><option>Pick List</option><option>Check List</option></select></div>' +
    '<div class="vacancy-quest-weight"><input type="text" class="v-quest-wght" name="Weight"></div></div>',
            
        //    <div class="editable-address"><input type="text" name="LocalName" class="input-small">' +
        //'<select type="select" name="QuedataType" class="input-small"><option>Small Text</option><option>Large Text</option><option>Pick List</option></select>' +
        //'<input type="text" name="Weight" class="input-mini"></div>',
...
(function ($) {
    ...
    var AnsOpt = function (options) {
        this.init('ansopt', options, AnsOpt.defaults);
    };

    //inherit from Abstract input
    $.fn.editableutils.inherit(AnsOpt, $.fn.editabletypes.abstractinput);

    $.extend(AnsOpt.prototype, {
        /**
        Renders input from tpl
...
@method value2html(value, element)
        **/
        value2html: function (value, element) {
            ...
            var html = '<div class="vacancy-quest-txt"> <div class="vacancy-quest-txt"><label class="v-type-label">' + value.LocalName + ' <span class="picklist-option"><a class="arrow-up" href="#"></a><a class="arrow-dwn" href="#"></a><a class="option-delete" href="#"></a></span></label></div> <div class="vacancy-typ-wght"><label class="weight-label">Option Value</label><label class="weight-value">' + value.Weight + '</label></div></div></div>'
            //var html = $('<div>').text(value.LocalName).html() + ', ' + $('<div>').text(value.QueDataType).html() +  $('<div>').text(value.Weight).html();
            $(element).html(html);
        },


        //// <label class="weight-label">Option Value</label>
//<label class="weight-value">@Model.Weight</label>
        /**
        Gets value from element's html
    ...
    AnsOpt.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        tpl: '<div class="editable-address"><div class="vacancy-quest-txt"><input type="text" class="v-quest-txt" name="LocalName"></div>' +
    ...
    $.fn.editabletypes.ansopt = AnsOpt;
